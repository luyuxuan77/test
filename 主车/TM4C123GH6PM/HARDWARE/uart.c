...
//*****************************************************************************
// 配置串口参数（可配置串口0-7）
// uint32_t ui32Base为串口基地址
// uint32_t ui32UARTClk为提供给UART的时钟频率，通过SysCtlClockGet()函数可以得到
// uint32_t ui32Config来配置串口的字长，校验位，停止位
void
...
//
//*****************************************************************************
// 判断缓存区是否有字符存在，如果有的话返回true，没有则返回false
bool
...
//
//*****************************************************************************
// 从指定的串口FIFO发送一个字符，如果没有字符发送不等待直接返回-1
bool
