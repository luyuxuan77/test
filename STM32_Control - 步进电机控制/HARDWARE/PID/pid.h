...
extern PID_TypeDef Encoder_Pid[4];
...
#define Encoder1_Pid     Encoder_Pid[0]
#define Encoder2_Pid     Encoder_Pid[1]
#define Encoder3_Pid     Encoder_Pid[2]
#define Encoder4_Pid     Encoder_Pid[3]
...
extern p_i_d_Value_TypeDef PID_Value_Encoder[4];
...
#define ENCODER_PID_TYPE			0   /*编码器控制PID算法类型，0位置式，1增量式*/
...
#define Encoder1_PID_Value_Encoder PID_Value_Encoder[0]
#define Encoder2_PID_Value_Encoder PID_Value_Encoder[1]
#define Encoder3_PID_Value_Encoder PID_Value_Encoder[2]
#define Encoder4_PID_Value_Encoder PID_Value_Encoder[3]
