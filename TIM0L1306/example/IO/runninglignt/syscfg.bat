...
set SYSCFG_PATH="C:\ti\sysconfig_1.18.1\sysconfig_cli.bat"
...
%SYSCFG_PATH% -o "%PROJ_DIR%.." -s "C:\ti\mspm0_sdk_1_20_01_06\.metadata\product.json" --compiler keil "%PROJ_DIR%..\%SYSCFG_FILE%"
